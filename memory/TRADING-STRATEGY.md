...
## Stop Ladder (Alpaca order fallback)
1. trailing_stop (trail_percent: "10", gtc)
2. Fixed stop 10% below entry (if PDT blocks trailing stop)
3. Queue stop for tomorrow AM in TRADE-LOG (if both blocked)
